...
<div class="navigationPanel">
    ...
    <a href="{{url('buyer/orders')}}">Orders</a>
</div>
...
@foreach($cereals as $cereal)
    <div class="productBox">
        <div class="divImage">
            <img src="/product_images/{{ $cereal->product_image }}" alt="Product Image" style="width: 100%; height: 100%; object-fit: cover;">
        </div>
        <h3 class="productText">product</h3>
        <h3 class="productText">KSh {{ $cereal->product_price }}</h3>
        <a href="{{ url('buyer/addToCart/'.$cereal->id) }}" class="fancyButton">Add to Cart</a>
    </div>
@endforeach
