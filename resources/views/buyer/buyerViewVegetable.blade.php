...
@foreach($vegetables as $vegetable)
    <div class="productBox">
        <div class="divImage">
            <img src="/product_images/{{$vegetable->product_image}}" alt="Product Image" style="width: 100%; height: 100%; object-fit: cover;">
        </div>
        <h3 class="productText">{{$vegetable->product_name}}</h3>
        <h3 class="productText">KSh {{$vegetable->product_price}}</h3>
        <a href="{{url('buyer/addToCart/'.$vegetable->id)}}" class="square-button   ">Add to Cart</a>
