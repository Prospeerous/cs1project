...
@foreach($legumes as $legume)
    <div class="productBox">
        <div class="divImage">
            <img src="/product_images/{{$legume->product_image}}" alt="Product Image" style="width: 100%; height: 100%; object-fit: cover;">
        </div>
        <h3 class="productText">{{$legume->product_name}}</h3>
        <h3 class="productText">KSh {{$legume->product_price}}</h3>
        <a href="{{url('buyer/addToCart/'.$legume->id)}}" class="square-button" >Add to Cart</a>
