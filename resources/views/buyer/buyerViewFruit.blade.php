...
@foreach($fruits as $fruit)
    <div class="productBox">
        <div class="divImage">
            <img src="/product_images/{{$fruit->product_image}}" alt="Product Image" style="width: 100%; height: 100%; object-fit: cover;">
        </div>
        <h3 class="productText">{{$fruit->product_name}}</h3>
        <h3 class="productText">KSh {{$fruit->product_price}}</h3>
        <a href="{{url('buyer/addToCart/'.$fruit->id)}}" class="square-button">Add to Cart</a>
